...
$("<div class=\"datagrid-header-check\"></div>").html("<input type=\"checkbox\" id=\"btnSelectAll\"/><label for=\"btSelectAll\" id=\"btSelectAll\"><span></span></label>").appendTo(td);
}else{
if(col.field){
td.attr("field",col.field);
...
cc.push(" name=\""+_7ce+"\" value=\""+(_7cf!=undefined?_7cf:"")+"\" id=\"btnSelectAll\"/><label for=\"btSelectAll\" id=\"btSelectAll\"><span></span></label>");
}else{
if(col.formatter){
